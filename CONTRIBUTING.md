...
This repository is an independent Doramagic AI context resource pack for continuedev/continue.
...
Do not use this repository as the upstream project's support tracker. If the bug is in continuedev/continue itself, report it to https://github.com/continuedev/continue/issues first and link the upstream issue here only when it changes this pack.
