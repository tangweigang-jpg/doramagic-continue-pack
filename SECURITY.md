...
This repository is an independent AI context resource pack for continuedev/continue. It is not Continue's official security contact.
...
Upstream product vulnerabilities should be reported to continuedev/continue's own security policy. Link the upstream advisory here only when this pack needs a mitigation or warning.
